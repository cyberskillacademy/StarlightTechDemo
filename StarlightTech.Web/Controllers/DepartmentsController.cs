...
namespace StarlightTech.Web.Controllers
{
    public class DepartmentsController : Controller
    {
        private readonly StarlightTechWebContext _context;

        public DepartmentsController(StarlightTechWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'StarlightTechWebContext.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StarlightTechWebContext.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
